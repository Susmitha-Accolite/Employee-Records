...
const headCells = [
  { id: 'fullName',  disablePadding: false, label: 'Fullname' },
  { id: 'department',  disablePadding: false, label: 'Department' },
  { id: 'mobile', disablePadding: false, label: 'Contact Number' },
  { id: 'city', disablePadding: false, label: 'City' },
  { id: 'state', disablePadding: false, label: 'State' },
  { id: 'zipcode', disablePadding: false, label: 'Zipcode' },
];
